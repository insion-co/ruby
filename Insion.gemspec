...
require_relative "lib/Insion/version"
...
Gem::Specification.new do |spec|
  spec.name = "Insion"
  spec.authors = ["Insion"]
  spec.version = Insion::VERSION
  spec.summary = "Ruby client library for the Insion API"
  spec.description = "The Insion Ruby library provides convenient access to the Insion API from Ruby."
