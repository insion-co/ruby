...
require_relative "lib/InsionClient/version"
...
Gem::Specification.new do |spec|
  spec.name = "InsionClient"
  spec.authors = ["InsionClient"]
  spec.version = InsionClient::VERSION
  spec.summary = "Ruby client library for the InsionClient API"
  spec.description = "The InsionClient Ruby library provides convenient access to the InsionClient API from Ruby."
